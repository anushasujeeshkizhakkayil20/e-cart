...
function Cart() {
  ...
  return (
    <div style={{marginTop:'150px'}}>
     ...
     <div className="col-lg-4 d-flex justify-content-center flex-column">
      <div className='border shadow p-5'>
        <h2 className='text-primary'>Cart summery</h2>
    ...
    <div style={{height:'100vh'}} className='d-flex flex-column justify-content-center align-items-center'>
        ...
        <h4 className='text-danger mt-3'> Your card is Empty</h4>
        <Button className='btn btn-success rounded'><Link style={{textDecoration:'none',color:'white'}} to={'/'}><i class="fa-solid fa-arrow-left me-3"></i>Back to Home</Link></Button>
        </div>
    }
